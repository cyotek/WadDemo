...
{
  public sealed class Wad1PatchDirectoryReader : WadDirectoryReader
  {
    #region Public Fields

    public static readonly Wad1PatchDirectoryReader Default = new Wad1PatchDirectoryReader();
    ...
    protected override WadType GetType(byte[] buffer) => WadType.Patch;
