...
{
  [TestFixture]
  public class Wad3DirectoryWriterTests : TestBase
  {
    ...
    public void FullWriteTest()
    {
      ...
      {
        using (WadOutputStream target = new WadOutputStream(output, WadType.Wad3))
        {
          byte[] expected;
          byte[] actual;

          expected = File.ReadAllBytes(this.GetDataFileName("nfo3.wad"));
    ...
    public void WriteHeaderTest()
    {
      ...
      value = new DirectoryHeader(WadType.Wad3, 1425, 09012022);
