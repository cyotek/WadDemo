...
{
  [TestFixture]
  public class Wad3DirectoryReaderTests : TestBase
  {
    ...
    public static IEnumerable<TestCaseData> ReadEntryTestCaseSource
    {
      get
      {
        yield return new TestCaseData("nfo3.wad", 1, new WadLump { Name = "PHOTO1", Size = 122, UncompressedSize = 122, CompressionMode = 1, Type = 2 }).SetName("{m}First");
        yield return new TestCaseData("nfo3.wad", 3, new WadLump { Name = "PHOTO5", Size = 135, UncompressedSize = 135, Type = 80 }).SetName("{m}Second");
      }
    }
    ...
    public static IEnumerable<TestCaseData> ReadHeaderTestCaseSource
    {
      get
      {
        yield return new TestCaseData("nfo3.wad", new DirectoryHeader(WadType.Wad3, 391, 3)).SetName("{m}");
    ...
    public void ReadHeaderTest()
    {
      ...
      expected = new DirectoryHeader(WadType.Wad3, 1425, 09012022);
